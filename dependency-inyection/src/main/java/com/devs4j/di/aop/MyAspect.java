...
@Order(1) // Como tenemos 2 Aspectos que tienen el mismo Join Point(clase "TargetObject"), con esta anotación podemos establecer el orden de ejecución de esos Aspectos
@Component
